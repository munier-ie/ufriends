      ...
      if (data?.status === "success" || data?.success === true || data?.status === true) {
        return {
          ...
          data: {
            ...
            firstName: data.data?.firstName || data.data?.first_name || data.data?.firstname || "",
            lastName: data.data?.lastName || data.data?.last_name || data.data?.surname || "",
            middleName: data.data?.middleName || data.data?.middle_name || data.data?.middlename || "",
            dateOfBirth: data.data?.dateOfBirth || data.data?.date_of_birth || data.data?.birthdate || data.data?.dob || "",
            gender: data.data?.gender || "",
            phone: data.data?.phone || data.data?.phoneNumber || data.data?.telephoneno || "",
            address: data.data?.address || data.data?.residence_address || "",
            ...
            stateOfOrigin: data.data?.stateOfOrigin || data.data?.state_of_origin || data.data?.birthstate || "",
            lga: data.data?.lga || data.data?.birthlga || "",
            maritalStatus: data.data?.maritalStatus || data.data?.marital_status || data.data?.maritalstatus || "",
            profession: data.data?.profession || "",
            religion: data.data?.religion || "",
            bloodGroup: data.data?.bloodGroup || data.data?.blood_group || "",
            height: data.data?.height || data.data?.heigth || "",
