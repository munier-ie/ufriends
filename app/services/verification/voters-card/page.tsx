...
export default function VotersCardVerificationPage() {
  ...
  const generatePDF = async () => {
    try {
      ...
      const filename = String(slipType).toLowerCase() === "full" ? "voters-card-full" : "voters-card-verification"
      await downloadPdfAutoWithData("voters.verify", apiResult, filename, slipType)
